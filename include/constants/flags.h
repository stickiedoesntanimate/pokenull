...
#define FLAG_RECIEVED_BADGE01_TICKETS                           (SYSTEM_FLAGS + 0x85) // Unused Flag
#define FLAG_RECIEVED_BADGE02_TICKETS                           (SYSTEM_FLAGS + 0x86) // Unused Flag
#define FLAG_RECIEVED_BADGE03_TICKETS                           (SYSTEM_FLAGS + 0x87) // Unused Flag
#define FLAG_RECIEVED_BADGE04_TICKETS                           (SYSTEM_FLAGS + 0x88) // Unused Flag
#define FLAG_RECIEVED_BADGE05_TICKETS                           (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_RECIEVED_BADGE06_TICKETS                           (SYSTEM_FLAGS + 0x8A) // Unused Flag
#define FLAG_RECIEVED_BADGE07_TICKETS                           (SYSTEM_FLAGS + 0x8B) // Unused Flag
#define FLAG_RECIEVED_BADGE08_TICKETS                           (SYSTEM_FLAGS + 0x8C) // Unused Flag
